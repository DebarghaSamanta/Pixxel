...
import { SignIn,SignInButton,SignOutButton,SignedOut,SignUpButton,SignedIn,UserButton } from '@clerk/nextjs'
...
const Header = () => {
  ...
  return (
    <header className='fixed top-6 left-1/2 transform -translate-x-1/2 z-50 text-nowrap'>
        ...
        className="min-w-24 object-cover" width={96} height={24}></Image>
        </Link>
        {path === "/" && (
